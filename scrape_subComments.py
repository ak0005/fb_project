...
def handleSubCommentData(postId, commentId, data):
    for subComment in data:
        if 'id' in subComment:
            ...
            if collection.count_documents({'_id': postId, 'comments.subComments': {'$elemMatch': {'_id': commentId, "_id": subComment['id']}}}, limit=1) > 0:
                continue
            ...
            collection.update_one({'_id': postId, 'comments': {'$elemMatch': {'_id': commentId}}}, {
